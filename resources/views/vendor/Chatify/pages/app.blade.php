...
<div class="h-screen">
        ...
        <div class="w-full md:container md:mx-auto">
            <div id="desktop-logo">
                <div class="flex flex-col items-center justify-center mx-auto"><a href="{{ route('/') }}"
                        title="JustLadies"><img id="logo-light" src="h{{ asset('img/auth_logo.png') }}"
                            alt="JustLadies Logo"> <img id="logo-dark" src="{{ asset('img/auth_logo.png') }}"
                            alt="JustLadies Logo"></a></div>
            </div>
                    ...
                    <ul class="flex justify-between items-center md:justify-end md:space-x-8">
                        ...
                        <li class="text-lg "><a href="@if(!Auth::user())
															...
															@else
																...
																@endif
															@endif"><i aria-hidden="true"
                                    class="fak fa-c-user"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="messenger">
        ...
        <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
            ...
            <div class="m-header">
                <nav class="py-4 mb-2">
                    <a href="{{ route('chat') }}"> <span class="messenger-headTitle"><h2 class="sm:w-80 font-bold text-3xl">
                    Conversations
                </h2></span>  </a>
                    {{-- header buttons --}}
                ...
                {{-- Search input --}}
                <input type="text" class="messenger-search" placeholder="Rechercher une conversation" />
                {{-- Tabs --}}
            ...
            <div class="messenger-tab search-tab app-scroll" data-view="search">
                    ...
                    <div class="search-records">
                        <p class="message-hint center-el"><span>Taper votre recherche..</span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="messenger-messagingView">
            ...
            {{-- Messaging area --}}
            <div class="m-body messages-container app-scroll position-relative">
                <div class="messages">
                    <p class="message-hint center-el"><span>Sélectionner une conversation pour afficher les messages</span></p>
                </div>
                {{-- Typing indicator --}}
